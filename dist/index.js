...
function DescriptionField(_a) {
    ...
    if (typeof description === 'string')
        return jsxRuntime.exports.jsx(reactNative.Text, { children: description });
    return jsxRuntime.exports.jsx(reactNative.View, __assign({ nativeID: id }, { children: description }));
}
...
function DefaultObjectFieldTemplate(_a) {
    ...
    return (jsxRuntime.exports.jsxs(reactNative.View, __assign({ nativeID: rest.idSchema.$id }, { children: [(rest.uiSchema['ui:title'] || rest.title) && (jsxRuntime.exports.jsx(TitleField, { id: "".concat(rest.idSchema.$id, "__title"), title: rest.title || rest.uiSchema['ui:title'], required: rest.required, formContext: rest.formContext })), rest.description && (jsxRuntime.exports.jsx(DescriptionField, { id: "".concat(rest.idSchema.$id, "__description"), description: rest.description, formContext: rest.formContext })), rest.properties.map(function (prop) { return prop.content; })] })));
}
function ObjectField(_a) {
    ...
    try {
        ...
        return (jsxRuntime.exports.jsxs(reactNative.View, { children: [jsxRuntime.exports.jsxs(reactNative.Text, { children: ["Invalid ", name || 'root', " object field configuration:", jsxRuntime.exports.jsx(reactNative.Text, { children: err.message }), "."] }), jsxRuntime.exports.jsx(reactNative.Text, { children: JSON.stringify(schema) })] }));
    }
...
function Label(_a) {
    ...
    if (!label)
        return null;
    return (jsxRuntime.exports.jsxs(reactNative.Text, { children: [label, required && REQUIRED_FIELD_SYMBOL$1] }));
}
function Help(_a) {
    var help = _a.help;
    if (!help)
    ...
    if (typeof help === 'string')
        return jsxRuntime.exports.jsx(reactNative.Text, { children: help });
    return jsxRuntime.exports.jsx(reactNative.Text, { children: help });
}
...
function DefaultTemplate(_a) {
    ...
    return (jsxRuntime.exports.jsx(reactNative.View, { children: jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, { children: [displayLabel && jsxRuntime.exports.jsx(Label, { label: label, required: required }), children, imageHint] }) }));
}
...
function TitleField(_a) {
    ...
    if (!title)
        return null;
    return (jsxRuntime.exports.jsxs(reactNative.View, __assign({ nativeID: id }, { children: [jsxRuntime.exports.jsx(reactNative.View, { children: title }), required && jsxRuntime.exports.jsx(reactNative.View, { children: REQUIRED_FIELD_SYMBOL })] }), id));
}
...
function UnsupportedField() {
    return jsxRuntime.exports.jsx(reactNative.Text, { children: "This field is unsupported" });
}
...
function Form(_a) {
    ...
    return (jsxRuntime.exports.jsx(Form$1, __assign({ registry: registry, platform: "mobile" }, rest, { children: typeof onSubmit === 'function' && !children ? (jsxRuntime.exports.jsx(reactNative.TouchableOpacity, { children: jsxRuntime.exports.jsx(reactNative.Text, { children: submitText || 'Submit' }) })) : (children) })));
}
